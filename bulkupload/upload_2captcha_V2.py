    ...
    while end_num >= start_num:
        ...
        if is_listing.get():
            ...
            try:
                ...
                wait_xpath('//button[text()="List for sale"]')

                # sell = driver.find_element(By.XPATH, '//a[text()="Sell"]')
                sell = driver.find_element(By.XPATH, '//button[text()="List for sale"]')
            ...
            select_durationday = driver.find_element(By.ID, "duration")
            ...
            # ethereum_button = driver.find_element(By.XPATH, range_button_location)
            ethereum_button = driver.find_element(By.CSS_SELECTOR, "[id^='tippy'] > .tippy-box > .tippy-content > div > ul > li:last-child > button")
            ...
            while wait_E:
                try:
                    ...
                    wait_xpath('//div[@role="dialog"]//h4[contains(text(), "Approve listing")]')  # HKN
            ...
            if is_polygon.get():
                ...
                '''
                #wait_xpath("//div[@data-testid='signature-request-scroll-button']") # 느려저서
                polygonscrollsign = driver.find_element(By.XPATH, "//div[@data-testid='signature-request-scroll-button']")
